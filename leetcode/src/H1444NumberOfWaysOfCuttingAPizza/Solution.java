package H1444NumberOfWaysOfCuttingAPizza;
...
public class Solution {
    ...
    public int ways(String[] pizza, int k) {
        ...
        // apples[i][j] means number of apples from (i, j) to (rows, cols)
        int[][] apples = new int[rows + 1][cols+1];
        // d[k][i][j] means number of possible cuts to cut (i, j) to (rows, cols) with k cuts remain.
